...
#   Character.create(name: 'Luke', movie: movies.first)
    ...
    sj5 = ServerJoin.create!({user_id: u2.id, server_id: s3.id})
    ...
    sj12 = ServerJoin.create!({user_id: u1.id, server_id: s4.id})
    sj13 = ServerJoin.create!({user_id: u1.id, server_id: s5.id})
    sj14 = ServerJoin.create!({user_id: u1.id, server_id: s6.id})
    sj15 = ServerJoin.create!({user_id: u1.id, server_id: s7.id})
    sj16 = ServerJoin.create!({user_id: u1.id, server_id: s8.id})
    sj17 = ServerJoin.create!({user_id: u1.id, server_id: s9.id})
    sj18 = ServerJoin.create!({user_id: u1.id, server_id: s10.id})
    sj19 = ServerJoin.create!({user_id: u1.id, server_id: s11.id})
    sj20 = ServerJoin.create!({user_id: u1.id, server_id: s12.id})
    sj21 = ServerJoin.create!({user_id: u1.id, server_id: s13.id})
    sj22 = ServerJoin.create!({user_id: u1.id, server_id: s14.id})
    sj23 = ServerJoin.create!({user_id: u1.id, server_id: s15.id})
